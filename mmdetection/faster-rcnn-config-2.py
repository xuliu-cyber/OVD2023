...
launcher = 'none'
load_from = './workdir/pre/epoch_2.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='json_final_contest/train_1class.json',
        backend_args=None,
        data_prefix=dict(img='data_final_contest/train/'),
        data_root='/home/liux/final/',
        pipeline=[
...
test_evaluator = dict(
    ann_file='../data/final/json_final_contest/train_1class.json',
    backend_args=None,
    metric='bbox',
    type='CocoMetric')
test_pipeline = [
